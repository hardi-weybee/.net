                ...
                <asp:GridView CssClass="gr1" ID="GridView1" runat="server" AutoGenerateColumns="False" EmptyDataText="There are no data records to display." CellPadding="4" GridLines="None" ForeColor="#333333" >
                    ...
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="Actions">
                            <ItemTemplate>
                                <asp:ImageButton CssClass="head" ID="EditBtn" runat="server" ImageUrl="~/images/icons8-edit.svg" OnClick="EditBtn_Click" ToolTip="Edit Party Name" />
                                <asp:ImageButton CssClass="del" ID="DeleteBtn" runat="server" ImageUrl="~/images/icons8-trash.svg" OnClick="DeleteBtn_Click" ToolTip="Delete Party Name" />
                            </ItemTemplate>
                        </asp:TemplateField>
                    </Columns>
